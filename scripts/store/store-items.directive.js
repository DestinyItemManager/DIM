        ...
        '<div>',
          ...
          '<div>',
            ...
            '<div class="items-Weapon sections">',
              '<div ng-repeat="(key, item) in vm.store.items | filter:{ sort : \'Weapon\' } | filter:{ equipped : false } | filter:{ equipment: true }" class="sort-{{ item.type.toLowerCase() }}">',
          ...
          '<div>',
            ...
            '<div class="item-Armor sections">',
              '<div ng-repeat="(key, item) in vm.store.items | filter:{ sort : \'Armor\' } | filter:{ equipped : false } | filter:{ equipment: true }" class="sort-{{ item.type.toLowerCase() }}">',
                '<div dim-store-item store-data="vm.store" item-data="item"></div>',
              '</div>',
            '</div>',
          '</div>',
