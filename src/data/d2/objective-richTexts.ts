const richTextManifestSourceData = {
  ...
  '[Hand Cannon]': ['Objective', 190392071],
  ...
  '[Linear Fusion Rifle]': ['Objective', 233397309],
  '[Machine Gun]': ['Objective', 169521666],
  ...
  '[Trace Rifle]': ['Objective', 538850654],
