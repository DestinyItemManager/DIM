const S8Sources: { [key: string]: number[] } = {
  calus: [
  ...
  mercury: [
    ...
    2413536545 // Tree of Probabilities
  ],
  titan: [
  ...
  crucible: [
    ...
    252414402, // Swordflight 4.1 (Opulence)
    328902054, // Swordflight 4.1 (Opulence)
    727838174, // Swordflight 4.1 (Opulence)
    1571781304, // Swordflight 4.1 (Opulence)
    1654427223, // Swordflight 4.1 (Opulence)
    1830829330, // Swordflight 4.1 (Opulence)
    2293476915, // Swordflight 4.1 (Opulence)
    2296560252, // Swordflight 4.1 (Opulence)
    1071350799, // Binary Phoenix Cloak (Opulence)
    2426070307, // Binary Phoenix Cloak (Opulence)
    2094233929, // Swordflight 4.1 (Worthy)
    2492669178, // Swordflight 4.1 (Worthy)
    2680535688, // Swordflight 4.1 (Worthy)
    3797729472, // Swordflight 4.1 (Worthy)
    87665893, // Binary Phoenix Cloak (Worthy)
    388771599, // Phoenix Strife Type 0 (Opulence)
    449878234, // Phoenix Strife Type 0 (Opulence)
    1548928853, // Phoenix Strife Type 0 (Opulence)
    2231762285, // Phoenix Strife Type 0 (Opulence)
    2543903638, // Phoenix Strife Type 0 (Opulence)
    3315265682, // Phoenix Strife Type 0 (Opulence)
    3756286064, // Phoenix Strife Type 0 (Opulence)
    3781722107, // Phoenix Strife Type 0 (Opulence)
    98331691, // Binary Phoenix Mark (Opulence)
    670877864, // Binary Phoenix Mark (Opulence)
    1727248109, // Phoenix Strife Type 0 (Worthy)
    1807196134, // Phoenix Strife Type 0 (Worthy)
    2674680132, // Phoenix Strife Type 0 (Worthy)
    2845947996, // Phoenix Strife Type 0 (Worthy)
    3884544409, // Binary Phoenix Mark (Worthy)
    85800627, // Ankaa Seeker IV (Opulence)
    419812559, // Ankaa Seeker IV (Opulence)
    761953100, // Ankaa Seeker IV (Opulence)
    876608500, // Ankaa Seeker IV (Opulence)
    3098458331, // Ankaa Seeker IV (Opulence)
    4043980813, // Ankaa Seeker IV (Opulence)
    4134090375, // Ankaa Seeker IV (Opulence)
    4211218181, // Ankaa Seeker IV (Opulence)
    1838158578, // Binary Phoenix Bond (Opulence)
    2291226602, // Binary Phoenix Bond (Opulence)
    215768941, // Ankaa Seeker IV (Worthy)
    852430165, // Ankaa Seeker IV (Worthy)
    1299272338, // Ankaa Seeker IV (Worthy)
    1765728763, // Ankaa Seeker IV (Worthy)
    4269346472 // Binary Phoenix Bond (Worthy)
  ],
  shaxx: [
    94507878, // Burnished Blade
    744199039, // Wing Contender
  ...
  moon: [
    1220931350, // A Fine Memorial
    3287201781, // Arc Logic
    394810086, // Dream Breaker
    2714352260, // Dreambane Bond
    4011353745, // Dreambane Boots
    2444529479, // Dreambane Cloak
    1925778651, // Dreambane Cowl
    2874010934, // Dreambane Gauntlets
    3436750447, // Dreambane Gloves
    4086393232, // Dreambane Greaves
    3426533770, // Dreambane Grips
    760455599, // Dreambane Helm
    4166880830, // Dreambane Hood
    2205906123, // Dreambane Mark
    2557452794, // Dreambane Plate
    1400083145, // Dreambane Robes
    2465745828, // Dreambane Strides
    2690548158, // Dreambane Vest
    4008494330, // Every Waking Moment
    4169533630, // Loud Lullaby
    1341880512, // Love and Death
    3273345532, // Night Terror
    597679579, // One Small Step
    4123554961, // Premonition
    1170891373 // Tranquility
  ],
  tangled: [
  ...
  mars: [
    ...
    4286845987, // Midnight Exigent Mark
    3691605010, // Midnight Exigent Plate
    1095937013, // Strange Terrain
    2237931050, // Will of the Thousands
    2034926084, // Yuga Sundown Bond
    2970562833, // Yuga Sundown Boots
    2395959535, // Yuga Sundown Gloves
    3126089918, // Yuga Sundown Helmet
