...
export const unsupported = {
  ...
  'pt-br': "A equipe do DIM não oferece suporte a este navegador. Alguns recursos do DIM podem não funcionar.",
  ru: "The DIM team does not support using this browser. Some or all DIM features may not work.",
  'zh-chs': "The DIM team does not support using this browser. Some or all DIM features may not work.",
  'zh-cht': "The DIM team does not support using this browser. Some or all DIM features may not work.",
};
...
export const steamBrowser = {
  ...
  'es-mx': "It looks like this page is loaded in Steam's browser. Due to its limited features and resources, it may unexpectedly or intermittently fail to run DIM. We cannot provide support for it.",
  ...
  'pt-br': "Parece que esta página foi aberta no navegador do Steam. Devido à limitações, a execução do DIM pode falhar de forma inesperada ou intermitente. Nós não podemos oferecer suporte a ele.",
  ...
  'zh-chs': "It looks like this page is loaded in Steam's browser. Due to its limited features and resources, it may unexpectedly or intermittently fail to run DIM. We cannot provide support for it.",
  'zh-cht': "It looks like this page is loaded in Steam's browser. Due to its limited features and resources, it may unexpectedly or intermittently fail to run DIM. We cannot provide support for it.",
};
