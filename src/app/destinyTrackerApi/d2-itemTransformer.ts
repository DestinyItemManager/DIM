...
import { DtrBasicItem, DtrItemFetchRequest } from '../item-review/d2-dtr-api-types';
...
class D2ItemTransformer {
   ...
   */
  translateToDtrItem(item: D2Item | DestinyVendorSaleItemComponent): DtrItemFetchRequest {
    return {
   ...
   */
  getRollAndPerks(item: D2Item): DtrBasicItem {
