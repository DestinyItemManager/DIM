...
/** Gets the effective stat tier from a stat value, clamping between 0-max */
export function statTier(stat: number, max = 10) {
  return _.clamp(Math.floor(stat / 10), 0, max);
}
