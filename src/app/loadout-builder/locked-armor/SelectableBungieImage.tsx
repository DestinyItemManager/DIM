...
export function SelectableMod({
  ...
  const perk = mod.perks?.length !== 0 && defs.SandboxPerk.get(mod.perks[0].perkHash);
...
export function SelectablePerk({
  ...
  const sandboxPerk = perk.perks?.length !== 0 && defs.SandboxPerk.get(perk.perks[0].perkHash);
