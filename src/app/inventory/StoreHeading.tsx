...
import glimmer from 'src/images/glimmer.png';
import legendaryMarks from 'src/images/legendaryMarks.png';
import legendaryShards from 'src/images/legendaryShards.png';
