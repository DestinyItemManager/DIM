  ...
  return (
    <div className="billboard">
      <div className="content">
        ...
        <p className="auth"><a rel="noopener noreferrer" href={authorizationURL}>{t("Views.Login.Auth")}</a></p>
        <p className="help"><a rel="noopener noreferrer" href="https://github.com/DestinyItemManager/DIM/wiki/Authorizing-Destiny-Item-Manager-with-Bungie.net">{t("Views.Login.LearnMore")}</a></p>
      </div>
    </div>
  );
}
