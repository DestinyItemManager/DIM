...
import auxOrnamentSets from 'data/d2/universal-ornament-aux-sets.json' with { type: 'json' };
import universalOrnamentPlugSetHashes from 'data/d2/universal-ornament-plugset-hashes.json' with { type: 'json' };
