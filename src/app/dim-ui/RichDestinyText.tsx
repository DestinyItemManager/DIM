...
const baseConversionTable: {
  ...
  { icon: melee,           exampleObjectiveHash: 3951261483, unicode: '', substring: null },
  ...
  { icon: damageKinetic,   exampleObjectiveHash: 3924246227, unicode: '', substring: null },
  { icon: headshot,        exampleObjectiveHash: 3287913530, unicode: '', substring: null },
