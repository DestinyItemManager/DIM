...
import DragPerformanceFix from 'app/inventory-page/DragPerformanceFix';
import { DestinyComponentType } from 'bungie-api-ts/destiny2';
import React from 'react';
import { useSelector } from 'react-redux';
import { DestinyAccount } from '../accounts/destiny-account';
import GearPower from '../gear-power/GearPower';
import { storesLoadedSelector } from '../inventory-stores/selectors';
import { useLoadStores } from '../inventory-stores/store/hooks';
