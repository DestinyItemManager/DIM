...
const cases = [
  ...
  // Perk column selectors: +colN stays attached to the filter's args, whether
  // the perk name is bare or quoted (the quoted form has +colN outside the quotes)
  [`perkname:rangefinder+col3`],
  [`perkname:"kill clip"+col3`],
  [`perkname:"kill clip"+col3+col4`],
  [`perk:"kill clip"+col3 is:weapon`],
