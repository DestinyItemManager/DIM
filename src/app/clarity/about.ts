...
const compendiumLinkDirect =
  'https://docs.google.com/spreadsheets/d/1WaxvbLx7UoSZaBqdFr1u32F2uWVLo-CJunJB4nlGUE4';
export const compendiumLink = `<a href='${compendiumLinkDirect}' target='_blank' rel='noopener noreferrer'>Pip1n's Destiny Data Compendium</a>`;
