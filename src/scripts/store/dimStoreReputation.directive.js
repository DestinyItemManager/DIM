...
var StoreReputation = {
  ...
  template: [
    ...
    '  <div class="reputation-bucket">',
    '    <div class="factionrep" ng-if="::rep.order >= 0" ng-repeat="rep in vm.store.progression.progressions | orderBy:\'order\' track by $index" title="{{::rep.faction.factionName}}\n{{rep.progressToNextLevel}}/{{rep.nextLevelAt}}">',
