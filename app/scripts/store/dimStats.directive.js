  ...
  function Stats() {
    return {
      ...
      template: [
        ...
        '    <img src="images/intellect.png" /><div class="bar" ng-repeat="n in vm.stats.STAT_INTELLECT.tiers track by $index">',
        ...
        '    <img src="images/discipline.png" /><div class="bar" ng-repeat="n in vm.stats.STAT_DISCIPLINE.tiers track by $index">',
        '      <div class="progress" ng-class="{complete: (n / 60) === 1 }" style="width:{{n/60*100}}%"></div></div></div>',
        '  <div class="stat" title="{{vm.formatTooltip(\'STAT_STRENGTH\')}}">',
        '    <img src="images/strength.png" /><div class="bar" ng-repeat="n in vm.stats.STAT_STRENGTH.tiers track by $index">',
        '      <div class="progress" ng-class="{complete: (n / 60) === 1 }" style="width:{{n/60*100}}%"></div></div></div>',
        '</div>'
      ].join('')
    };
