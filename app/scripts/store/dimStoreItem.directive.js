  ...
  function StoreItem(dimItemService, dimStoreService, ngDialog, dimLoadoutService, $rootScope, dimActionQueue) {
    ...
    return {
      ...
      template: [
        ...
        '    <span ng-if="vm.item.tag===\'favorite\'" class="item-tag fa fa-star"></span>',
        '    <span ng-if="vm.item.tag===\'keep\'" class="item-tag fa fa-tag"></span>',
        '    <span ng-if="vm.item.tag===\'delete\'" class="item-tag fa fa-ban"></span>',
