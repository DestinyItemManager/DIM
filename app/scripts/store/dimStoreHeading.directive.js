  ...
  function StoreHeading(ngDialog) {
    return {
      ...
      template: [
        ...
        '  <div class="glimmer" ng-show="!vm.isGuardian">Glimmer: {{ vm.store.glimmer }}</div>',
        '  <div class="legendaryMarks" ng-show="!vm.isGuardian">Legendary Marks: {{ vm.store.legendaryMarks }}</div>',
