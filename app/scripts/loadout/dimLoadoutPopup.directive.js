  ...
  function LoadoutPopup() {
    return {
      ...
      template: [
        ...
        '      <span ng-click="vm.newLoadout($event)"><i class="fa fa-plus-circle"></i> <span translate>CreateLoadout</span></span>',
        '      <span ng-click="vm.newLoadoutFromEquipped($event)" translate="LoadoutFromEquipped"></span>',
        '    </li>',
        ...
        '      <span translate-attr="{ title: \'DeleteLoadout\' }" ng-click="vm.deleteLoadout(loadout, $event)"><i class="fa fa-trash-o"></i></span>',
        '      <span translate-attr="{ title: \'EditLoadout\' }" ng-click="vm.editLoadout(loadout, $event)"><i class="fa fa-pencil"></i></span>',
        '    </li>',
        '    <li class="loadout-set" ng-if="vm.search.query">',
        '      <span ng-click="vm.searchLoadout($event)"><i class="fa fa-search"></i> {{ \'ApplySearchLoadout\' | translate:{ query: vm.search.query } }}</span>',
        '    </li>',
        '    <li class="loadout-set" ng-if="!vm.store.isVault">',
        '      <span ng-click="vm.maxLightLoadout($event)"><i class="fa fa-star"></i> <span translate>MaximizeLight</span> <span class="light" ng-bind="::vm.maxLightValue"></span></span>',
        '    </li>',
        '    <li class="loadout-set" ng-if="!vm.store.isVault">',
        '      <span ng-click="vm.itemLevelingLoadout($event)"><i class="fa fa-level-up"></i> <span translate>ItemLeveling</span></span>',
        '    </li>',
        '    <li class="loadout-set">',
        '      <span ng-click="vm.gatherEngramsLoadout($event, { exotics: true  } )"><img class="fa" src="/images/engram.svg" height="12" width="12"/> <span translate>GatherEngrams</span></span>',
        '      <span ng-click="vm.gatherEngramsLoadout($event, { exotics: false })"><i class="fa fa-ban"></i> <span translate>GatherEngramsExceptExotics</span></span>',
        '    </li>',
        '    <li class="loadout-set" ng-if="!vm.store.isVault">',
        ...
        '      <span ng-click="vm.applyLoadout(vm.previousLoadout, $event)"><span translate>RestoreAllItems</span></span>',
        '    </li>',
        '  </ul>',
        '</div>'
      ].join('')
