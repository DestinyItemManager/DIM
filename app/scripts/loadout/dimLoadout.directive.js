  ...
  function Loadout(dimLoadoutService) {
    return {
      ...
      template: [
        ...
        '      <form name="vm.form">',
        '        <input name="name" ng-model="vm.loadout.name" minlength="1" maxlength="50" required type="search" translate-attr="{ placeholder: \'LoadoutName\' }" />',
        ...
        '        <button ng-disabled="vm.form.$invalid" ng-click="vm.save()" translate>Save</button>',
        '        <button ng-disabled="vm.form.$invalid || !vm.loadout.id" ng-click="vm.saveAsNew()" translate>SaveAsNew</button>',
        '        <button ng-click="vm.cancel()" translate>Cancel</button>',
        '        <span><img src="images/spartan.png" style="border: 1px solid #333; background-color: #f00; margin: 0 2px; width: 16px; height: 16px;  vertical-align: text-bottom;"> <span translate>ItemsWithIcon</span>  <span translate>ClickToEquip</span></span>',
