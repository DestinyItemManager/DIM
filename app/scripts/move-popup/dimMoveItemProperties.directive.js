  ...
  function MoveItemProperties() {
    return {
      ...
      template: [
        ...
        '    <a href="#" ng-click="vm.setLockState(vm.item);">',
        '      <i class="fa lockable" ng-if="vm.item.lockable" ng-class="{ \'fa-lock\': vm.item.locked, \'fa-unlock-alt\': !vm.item.locked, locking: vm.locking }"></i>',
        '    </a>',
        '    </span>',
