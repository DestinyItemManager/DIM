          ...
          <div class="item-perks">
            <div ng-repeat="perk in vm.item.perks track by $index" class="item-perk-row">
              <div class="item-perk-icon"
                ...
                style="background-image: url(http://bungie.net{{ perk.iconPath }})">
              </div>

              <span class="perk-title">{{perk.displayName}}</span>
              <span class="perk-description">{{perk.displayDescription}}</span>
            </div>
            <div ng-if="vm.isInfusable(vm.item)" class="item-perk-row">
              <div class="item-perk-icon"
                ng-click="vm.infuse(vm.item, $event)"
                title="Infusion calculator"
                alt="Infusion calculator"
                style="background-image: url('/images/{{vm.item.sort}}.png');cursor:pointer;">
              </div>
            </div>
          </div>
        </div>
