  ...
  function MoveItemProperties() {
    return {
      ...
      template: [
        ...
        '      <span class="stat-box-cell" ng-style="vm.item.quality.min | qualityColor:\'color\'" translate>{{ vm.item.quality.range }} Stats.OfMaxRoll <a href="https://github.com/DestinyItemManager/DIM/wiki/View-how-good-the-stat-(Int-Dis-Str)-roll-on-your-armor-is"><i class="fa fa-question-circle" translate-attr="{ title: PercentHelp}"></i></a></span>',
        '    </div>',
        '  </div>',
