  ...
  function MoveItemProperties() {
    return {
      ...
      template: [
        ...
        '    <i class="fa lockable" ng-if="vm.item.lockable" ng-class="{ \'fa-lock\': vm.item.locked, \'fa-unlock-alt\': !vm.item.locked, locking: vm.locking }" ng-click="vm.setLockState(vm.item);"></i>',
        '    </span>',
