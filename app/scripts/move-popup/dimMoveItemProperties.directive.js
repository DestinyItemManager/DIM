  ...
  function MoveItemProperties() {
    return {
      ...
      template: [
        ...
        '      <i ng-if="objective.displayStyle === \'trials\'" class="fa fa-circle trials" ng-repeat="i in vm.getNumber(objective) track by $index" ng-class="{\'incomplete\': $index >= objective.progress, \'wins\': objective.completionValue === 9}"></i>',
