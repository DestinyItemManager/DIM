  ...
  function MovePopup(ngDialog) {
    return {
      ...
      template: [
        ...
        '      <div ng-if="vm.canShowVault(vm.item, vm.store, store)" class="item-target-options">',
        ...
        '          <div class="item-target-options-text">Vault</div>',
        '        </div>',
        '      </div>',
        '      <div ng-if="vm.canShowEquip(vm.item, vm.store, store)" class="item-target-options">',
        ...
        '          <div class="item-target-options-text">Equip</div>',
        '        </div>',
        '        <div ng-if="vm.canShowStore(vm.item, vm.store, store)"class="move-button move-store" ng-class="{ \'little\': item.notransfer }" alt="{{ vm.characterInfo(store) }}" title="{{ vm.characterInfo(store) }}" ',
        ...
        '          <div class="item-target-options-text">Store</div>',
        '        </div>',
        '      </div>',
        '    </div>',
        '  </div>',
