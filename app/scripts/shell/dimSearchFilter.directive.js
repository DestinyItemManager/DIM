(function() {
  ...
  function SearchFilter(dimSearchService) {
    return {
      ...
      restrict: 'A',
      template: [
        '<input id="filter-input" translate-attr="{ placeholder: \'FilterHelp\' }" type="search" name="filter" ng-model="vm.search.query" ng-model-options="{ debounce: 500 }" ng-trim="true">'
      ].join('')
    };
  }
